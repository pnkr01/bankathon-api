import openai
from helper.clean_response import clean_object
...
def enhance_jd( request_id,job_description):
    ...
    return clean_object(response['choices'][0]['message']['content'])


# respose in format of json object with key request id anf enhanced_jd